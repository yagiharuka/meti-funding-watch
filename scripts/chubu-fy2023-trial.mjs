...
const docs = [
  ...
  {...base,id:"trial-g2",category:"grant_decision",kind:"補助金等の交付決定（10月～3月）",amountStage:"交付決定額欄の掲載値",file:"r5fy_10-3.pdf",pdfSchema:{schemaVersion:1,extractionMode:"positioned_text_only",normalizeCompatibilityText:true,expectedBytes:201458,expectedSha256:"d81b9409cf04fee5ce77245d179e66a34789df635e616575e6adff21580055a7",expectedPageCount:4,expectedPageSize:pageSize,expectedRowsPerPage:[12,14,14,14],expectedRecordCount:54,expectedRowNumbers:{start:1,end:54},headersOnFirstPageOnly:true,requiredPageText:[],requiredFirstPageText:["令和05年度補助金等の情報","中部経済産業局"],columns:grantColumns([28,50,200,320,385,445,545,665,725,760]),recordMapping:{ordinalColumn:"ordinal",programColumn:"program",organizationColumn:"organization",corporateNumberColumn:"corporateNumber",amountColumn:"amount",dateColumn:"date",notesColumns:["account","budgetItem"]},allowedDateFormats:["reiwa_ymd_ja"],dateRange:{start:"2023-10-01",end:"2024-03-31"},corporateNumberMissingSentinels:["","-","－"],minimumPositionedTextItems:1}},
